...
class CartItem extends StatelessWidget {
  const CartItem({
    ...
    required this.onPlusButtonClicked,
    required this.onMinusButtonClicked,
  });

  final CartItemEntity data;
  final GestureTapCallback onDeleteButtonClick;
  final GestureTapCallback onPlusButtonClicked;
  final GestureTapCallback onMinusButtonClicked;
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                            onPressed: onPlusButtonClicked,
                            icon: const Icon(CupertinoIcons.plus_rectangle)),
                        data.changeCountLoding
                        ...
                        IconButton(
                            onPressed: onMinusButtonClicked,
